		...
		<div id="show-accountType" class="content scaffold-show" role="main">
			...
			<ol class="property-list accountType">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="accountType.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${accountTypeInstance}" field="name"/></span>
				...
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="accountType.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${accountTypeInstance}" field="description"/></span>
