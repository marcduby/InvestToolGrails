...
<html>
	...
	<body>
		<a href="#create-symbol" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-symbol" class="content scaffold-create" role="main">
