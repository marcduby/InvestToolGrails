			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="transaction.security.label" default="Security" /></th>
					
						<th><g:message code="transaction.symbol.label" default="Symbol" /></th>
				...
				<g:each in="${transactionInstanceList}" status="i" var="transactionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: transactionInstance, field: "security")}</td>
					
						<td>${fieldValue(bean: transactionInstance, field: "symbol")}</td>
